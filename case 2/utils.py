...
# controller clamps `v` above ~3.14 rad/s (180 deg/s, the UR5e limit on every
# joint), and the older recordings in data/ ask for 20..100, i.e. every one of
# them ran at the joint limit. See collect.py.
